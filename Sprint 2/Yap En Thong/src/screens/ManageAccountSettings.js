        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerTitleContainer}>
            <Text style={styles.headerTitle}>
              {isAdminView ? 'Manage User Account' : 'Account Settings'}
            </Text>
            {isAdminView && (
              <Text style={styles.adminSubtitle}>Admin View - {studentName} • Real-time Sync</Text>
            )}
          </View>
        ...
        {!isAdminView && (
          <View style={styles.section}>
            ...
            <Text style={styles.logoutHint}>
              This will sign you out from all devices • Real-time sync
            </Text>
          </View>
        )}
          ...
          <View style={styles.confirmModal}>
            ...
            <Text style={styles.confirmMessage}>
              {isAdminView 
                ...
                : 'Are you sure you want to log out?\n\nYou will need to sign in again to access your account. Changes sync in real-time.'}
            </Text>
