...
const NODE_API_BASE_URL = 'http://10.0.2.2:3000';
const FLASK_API_BASE_URL = 'http://10.0.2.2:5000';
...
const AdminHomeScreen = ({ route, ...props }) => {
  ...
  const navigateToManageConversions = () => {
    navigation.navigate('ManageConversion',{user});
  };
      ...
      >
        ...
        {layoutConfig.showQuickActions && (
          <View style={styles.quickActions}>
            ...
            <TouchableOpacity
              style={[styles.actionButton, styles.manageConversionsButton]}
              onPress={navigateToManageConversions}
            >
              <View style={[styles.actionIconContainer, { backgroundColor: '#ff56ff' }]}>
                <Text style={styles.actionIcon}>📈</Text>
              </View>
              <Text style={styles.actionButtonText}>Manage Conversions</Text>
            </TouchableOpacity>
          </View>
        )}
